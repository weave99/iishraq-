...
//`feature_4`, `feature_5`, `feature_6`SELECT * FROM `product_details` WHERE 1
 ...
 <form method="post" action="finalCheckout.php">
    <input type="hidden" name="amount" value="<?php echo $sub_total*1+150;?>" >
    <input type="hidden" name="user_name" value="<?php echo $session_user_name;?>">
    
    <input type="submit" name="submit" Value="Check Out" style="background-color:black; color:#fff;">
 </form>
                    </div>
                </div>
            </div>
