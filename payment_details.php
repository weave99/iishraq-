...
<section class="set-position">
    ...
    <form action="PHP/techprocess.php" method="post">        
        <div class="row pb-4">
            <?php 
            ...
            if($f=mysqli_fetch_array($query1)) 
           {
            ...
            <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control" type="hidden" name="amount" value="<?php echo $_POST['amount'];?>" placeholder="">
                         <input class="form-control" type="hidden" name="mail_id" value="<?php echo $_POST['mail_id'];?>" placeholder="">
                          <input class="form-control" type="hidden" name="user_id" value="<?php echo $_POST['user_id'];?>" placeholder="">
                           <input class="form-control" type="hidden" name="cust_name" value="<?php echo $_POST['cust_name'];?>" placeholder="">
                            <input class="form-control" type="hidden" name="trans_no" value="<?php echo $_POST['trans_no'];?>" placeholder="">
